...
class Exanto_Heidelpay_Block_Processing extends Mage_Core_Block_Template
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('heidelpay/processing.phtml');
    }
    
    protected function getWpfScreen()
    {
        $payment = $this->getOrder()->getPayment()->getMethodInstance();
        return $payment->getWpfUrl();
    }
}